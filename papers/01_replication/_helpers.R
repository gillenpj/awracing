# _helpers.R
# Plotting helpers used inside the paper-1 .qmd files. Two functions:
...
#                           win rate.
# Kept inside papers/01_replication/ so the paper renders as a self-contained
# project. Not sourced by the pipeline.
